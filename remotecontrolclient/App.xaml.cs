...
using remotecontrolclient.ViewModels;
...
namespace remotecontrolclient
{
    public partial class App : Application
    {
        ...
        //    private set;
        //}
        //public String ServerCurrentWorkingDirectory
        //{
        //    get;
        //    private set;
        //}
        //public Stack<StorageFolder> PhoneCurrentWorkingDirectory
        //{
        //    get;
        //    set;
        //}
        ...
        {
            //PhoneCurrentWorkingDirectory = new Stack<StorageFolder>();
            //PhoneCurrentWorkingDirectory.Push(Windows.Storage.ApplicationData.Current.LocalFolder);

            //Change LANG - ENGLISH!!!!!!!!!!!!!!!!!!!!
            
           // --------------------------------------------------------------------------------
            //var cultureInfo = new CultureInfo("be-BY"); //be-BY//en-US//ru-RU
