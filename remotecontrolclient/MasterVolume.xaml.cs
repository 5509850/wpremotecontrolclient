...
{
    public partial class MasterVolume : PhoneApplicationPage
    {
        public MasterVolume()
        {
            InitializeComponent();
        ...
        private void bt_99_Click(object sender, RoutedEventArgs e)
        {
            SendCode(vol99);
        }

        private void bt_77_Click(object sender, RoutedEventArgs e)
        {
            SendCode(vol77);
        }

        private void bt_55_Click(object sender, RoutedEventArgs e)
        {
            SendCode(vol55);
        }

        private void bt_33_Click(object sender, RoutedEventArgs e)
        {
            SendCode(vol33);
        }
        ...
        private void bt_less_Click(object sender, RoutedEventArgs e)
        {
            SendCode(voldown);
        }

        private void but_back_Click_1(object sender, RoutedEventArgs e)
        {
            NavigationService.GoBack();
        }
